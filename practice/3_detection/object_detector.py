...
sys.path.append(r'C:\Program Files (x86)\Intel\openvino_2021.4.582\deployment_tools\open_model_zoo\demos\common\python')
import models
...
def draw_detections(frame, detections, labels, threshold):
    ...
    for detection in detections:
        ...
        topleft = (int(detection.xmin), int(detection.ymin))
        bottomright = (int(detection.xmax), int(detection.ymax))

        cv2.rectangle(frame, topleft, bottomright, color, line_width)
